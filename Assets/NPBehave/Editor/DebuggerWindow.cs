...
//            nodeTextStyle = new GUIStyle(EditorStyles.label);
        ...
        private void DrawNodeTree(Node node, int depth = 0, bool firstNode = true, float lastYPos = 0f)
        {
            ...
            GUI.color = (node.NodeState == Node.eNodeState.eACTIVE) ? new Color(1f, 1f, 1f, 1f) : new Color(1f, 1f, 1f, 0.3f);
        ...
        private void DrawNode(Node node, int depth, bool connected)
        {
            ...
            bool inactive = node.NodeState != Node.eNodeState.eACTIVE;
            ...
            EditorGUILayout.BeginHorizontal();
            {
                ...
                // Draw Buttons
                if (node.NodeState == Node.eNodeState.eACTIVE)
                {
